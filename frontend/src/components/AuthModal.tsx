...
export function AuthModal({ onClose }: { onClose: () => void }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#5b7083]/40" onClick={onClose}>
             <div 
                className="bg-black w-full max-w-[600px] h-full sm:h-auto sm:min-h-[400px] rounded-2xl flex flex-col items-center justify-center p-8 relative overflow-y-auto"
